...
var logOut = document.getElementById("logout"); // Login function with condition
...
if (logOut) logOut.addEventListener('click', _login.logout); // Vanhoja funktioita, voi katsoa mallia joihinkin osiin
