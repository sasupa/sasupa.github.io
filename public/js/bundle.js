        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              async: true,
              // Tää poistaa yhden deprecation-ilmon, ei muuta
              method: 'POST',
              url: 'users/login',
              data: {
                email: email,
...
},{"axios":"../../node_modules/axios/index.js"}],"google.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return window.open("https://accounts.google.com/o/oauth2/v2/auth?client_id=159039144246-fuu5h5n07b9s525dhefohaaf9fdg9v9h.apps.googleusercontent.com&response_type=code&scope=https://www.googleapis.com/auth/calendar&redirect_uri=http://localhost:5000/&access_type=offline");
...
var state = {}; // Login function with condition
...
['hashchange', 'load'].forEach(function (event) {
  return window.addEventListener(event, function () {
    var url = window.location.href; // Checking if url includes the code we need

    if (url.includes('code=')) {
      // Extracting the code part and saving it to state to make it accessble outside this function
      state.uri = url.split('code=')[1]; // Calling the Auth with POST
